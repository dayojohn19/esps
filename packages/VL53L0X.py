...
vl53l0x_scl = 18
vl53l0x_int = None
I2C_bus = I2C( sda=Pin(vl53l0x_sda), scl=Pin(vl53l0x_scl))
tof = VL53L0X(I2C_bus) # range to interrupt
...
SYSRANGE_THRESH_HIGH = 0x0C  # High threshold register
SYSRANGE_THRESH_LOW = 0x0E   # Low threshold register
GPIO_MUX_ACTIVE_HIGH = 0x0A  # Interrupt configuration register (example)
